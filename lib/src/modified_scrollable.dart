...
///
/// [ModifiedScrollable] implements the interaction model for a scrollable widget,
/// including gesture recognition, but does not have an opinion about how the
/// viewport, which actually displays the children, is constructed.
///
/// It's rare to construct a [ModifiedScrollable] directly. Instead, consider [ListView]
/// or [GridView], which combine scrolling, viewporting, and a layout model. To
/// combine layout models (or to use a custom layout mode), consider using
/// [CustomScrollView].
///
/// The static [ModifiedScrollable.of] and [ModifiedScrollable.ensureVisible] functions are
/// often used to interact with the [ModifiedScrollable] widget inside a [ListView] or
/// a [GridView].
///
...
///    that keeps the same page visible when the [ModifiedScrollable] resizes.
///
/// See also:
///
...
class ModifiedScrollable extends StatefulWidget {
  /// Creates a widget that scrolls.
  ///
  /// The [axisDirection] and [viewportBuilder] arguments must not be null.
  const ModifiedScrollable({
    super.key,
  ...
  /// [ScrollAction].
  ///
  /// If not supplied, the [ModifiedScrollable] will scroll a default amount when a
  ...
  /// Whether the scroll actions introduced by this [ModifiedScrollable] are exposed
  ...
  /// clipping of the [ModifiedScrollable]. This reflects the same [Clip] that is provided
  ...
  @override
  ModifiedScrollableState createState() => ModifiedScrollableState();
  ...
  /// ```
  ///
  /// Calling this method will create a dependency on the closest [ModifiedScrollable]
  /// in the [context], if there is one.
  static ModifiedScrollableState? of(BuildContext context) {
  ...
  ///
  /// The heuristic used is determined by the [physics] of this [ModifiedScrollable]
  ...
  ///
  /// If there is no [ModifiedScrollable] in the widget tree above the [context], this
  ...
  static Future<void> ensureVisible(
    ...
    ModifiedScrollableState? scrollable = ModifiedScrollable.of(context);
    while (scrollable != null) {
      ...
      scrollable = ModifiedScrollable.of(context);
    }
...
class _ScrollableScope extends InheritedWidget {
  ...
  final ModifiedScrollableState scrollable;
...
/// State object for a [ModifiedScrollable] widget.
///
/// To manipulate a [ModifiedScrollable] widget's scroll position, use the object
/// obtained from the [position] property.
///
/// To be informed of when a [ModifiedScrollable] widget is scrolling, use a
/// [NotificationListener] to listen for [ScrollNotification] notifications.
///
/// This class is not intended to be subclassed. To specialize the behavior of a
/// [ModifiedScrollable], provide it with a [ScrollPhysics].
class ModifiedScrollableState extends State<ModifiedScrollable> with TickerProviderStateMixin, RestorationMixin
    implements ScrollContext {
  /// The manager for this [ModifiedScrollable] widget's viewport position.
  ///
  /// To control what kind of [ScrollPosition] is created for a [ModifiedScrollable],
  ...
  bool _shouldUpdatePosition(ModifiedScrollable oldWidget) {
  ...
  @override
  void didUpdateWidget(ModifiedScrollable oldWidget) {
    ...
    Widget result = _ScrollableScope(
      ...
      child: Listener(
        ...
        child: RawGestureDetector(
          ...
          // TODO(tungpx): changed HitTestBehavior amd remove IgnorePointer
...
class _ScrollableSelectionHandler extends StatefulWidget {
  ...
  final ModifiedScrollableState state;
  final ScrollPosition position;
  final Widget child;
...
class EdgeDraggingAutoScroller {
  ...
  /// The [ModifiedScrollable] this auto scroller is scrolling.
  final ModifiedScrollableState scrollable;
...
Offset _getDeltaToScrollOrigin(ModifiedScrollableState scrollableState) {
